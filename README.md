...
project
│
├─ usecase1\_ai\_logging.py
├─ usecase2\_decision\_replay.py
├─ usecase3\_boundary\_check.py
├─ usecase4\_node\_pattern\_review.py
├─ usecase5\_multilingual\_concept\_review.py
├─ usecase6\_translation\_drift\_analysis.py
│
├─ inputs/
├─ multilingual\_inputs/
├─ output/
│
├─ cbp\_nodes.json
├─ .env.example
...
python usecase5\_multilingual\_concept\_review.py

or

python usecase6\_translation\_drift\_analysis.py
Why This Matters
